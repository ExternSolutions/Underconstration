...
$chk = mysql_query("SELECT * FROM issue where item_name='$item' AND sl_no='$slno' AND return_date='0000-00-00'");
if($chk == FALSE) { 
...
$sql = "UPDATE issue SET `return_date`='$dt' WHERE (`roll_no` ='$roll' AND `item_name` = '$item' AND `sl_no` = '$slno') OR(`gp_id` ='$grp' AND `item_name` = '$item' AND `sl_no` = '$slno') ";
                            ...
                            <div class="row" style="padding-left:30px;padding-right:30px;"  >
									...
									<p><font color="#FF0000"><span class="error"> *Group Id or Roll No</span></font></p>
                                        <div class="form-group">
                                            <label>Roll No<span class="error"> *</span></label>&nbsp;&nbsp;&nbsp;<input  style="float:left;" class="form-control" name="roll" placeholder="Please enter item name" size="20"><span class="error"> <?php echo $nameErr;?></span>
                                                    </div>              
                                        <div class="form-group">
